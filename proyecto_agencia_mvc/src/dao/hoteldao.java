...
public class hoteldao {
    ...
    public void insert(hotel h) throws Exception {
        String sql = "INSERT INTO hotel (nombre, direccion, ciudad, telefono) VALUES (?, ?, ?, ?)";
    ...
    public List<hotel> listar() throws Exception {
        ...
        String sql = "SELECT id_hotel, nombre, direccion, ciudad, telefono FROM hotel ORDER BY nombre";
